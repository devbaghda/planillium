...
public class AppState
{
    ...
    // The actual content behind the unread dot (2026-07-22 request — the dot alone gave no way
    // to see what it was about after clicking the tray icon). Capped in NotificationCenter, not
    // here, so this stays a short "what did I miss" recap rather than an unbounded log.
    [JsonPropertyName("pending_notifications")] public List<PendingNotification> PendingNotifications { get; set; } = new();
}
